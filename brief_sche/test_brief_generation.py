...
from brief_sche.brief_prompts import build_lesson_brief_prompt
from brief_sche.brief_processor import (
    call_ai_for_brief,
    save_lesson_brief,
...
async def test_single_teacher_brief(teacher_id: str, teacher_name: str = None):
    ...
    for sc in subject_classes:
        ...
        try:
            ...
            retrieved_chunks = []
            try:
                from brief_sche.brief_retrieval import retrieve_chunks_for_lesson
