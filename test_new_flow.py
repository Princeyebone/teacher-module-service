...
import os
from gcs_utils import generate_file_name
...
if __name__ == "__main__":
    ...
    print("1. Frontend sends file to backend /timetable/upload endpoint")
    print("2. Backend saves file locally and generates signed URL for GCS")
    print("3. Backend returns signed URL + other info to frontend")
    print("4. Frontend uploads to GCS directly")
    print("5. Backend processes file for text extraction in background")
    print("6. Backend deletes local file after text extraction")