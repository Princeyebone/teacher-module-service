...
from model import TeacherProfile, Student, AssessmentAssignment, Assessment, SecuritySetting, StudentAccessRule, AssessmentQuestion, AssignmentStatus, StudentEnrollment
...
async def delete_assignment_cascade(
    ...
    try:
        ...
        from model import StudentSubmission, SubmissionAnswer, SurveillanceLog
