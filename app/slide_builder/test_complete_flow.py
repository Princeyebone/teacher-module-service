...
async def test_curriculum_retrieval(session_data: dict):
    ...
    try:
        from app.slide_builder.slide_processor import get_curriculum_for_session
...
async def test_rag_retrieval(session_data: dict, curriculum: dict):
    ...
    try:
        from app.slide_builder.slide_retrieval import retrieve_all_pillars_for_slides, format_chunks_for_ai_prompt
...
async def test_ai_generation(session_data: dict, curriculum: dict, rag_content: str):
    ...
    try:
        from app.slide_builder.slide_processor import (
...
async def test_save_slide_deck(session_data: dict, curriculum: dict, slides_data: dict):
    ...
    try:
        from app.slide_builder.slide_processor import save_slide_deck
...
async def test_save_image_prompts(slide_id: str, slides_data: dict):
    ...
    try:
        from app.slide_builder.slide_processor import save_image_prompts
        from app.slide_builder.slide_prompts import extract_image_prompts_from_slides
...
async def test_generate_images(slide_id: str):
    ...
    try:
        from app.slide_builder.image_generator import generate_images_for_slide
...
async def test_student_lesson_pack(slide_id: str, session_data: dict):
    ...
    try:
        from app.slide_builder.student_pack_generator import generate_student_pack
