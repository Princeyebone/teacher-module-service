...
from app.schemas.schemas import AssessmentCountResponse
import io
import csv
import secrets
import string
...
from app.models.model import Student, TeacherProfile
from app.core.dependencies import get_current_teacher, get_current_student
from app.api.routers.student_auth import get_password_hash, change_student_password, create_student_tokens, verify_password
