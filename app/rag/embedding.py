...
try:
    from app.core.config import settings  # assuming you already load this globally
...
async def process_embedding_task(ctx: dict, teacher_id: str, knowledge_id: int, chunks: List[str], metadata: dict):
    ...
    try:
        ...
        from app.models.model import KnowledgeMetadata, KnowledgeEmbedding
        from sqlalchemy import select, update
        from app.rag.text import sanitize_text_for_database  # Import sanitization function
    except ImportError as e:
