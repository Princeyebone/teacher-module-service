...
from app.models.model import TeacherNotification, TempExtract
from app.sch_ground.background import arq_redis_settings, async_engine, publish_ws_message, save_notification
    ...
    try:
        ...
        if not os.path.exists(file_path) and gcs_file_name:
            ...
            try:
                ...
                from app.services.gcs_utils import get_gcs_client
            ...
            async with AsyncSession(async_engine) as db_session:
                try:
                    ...
                    if acc:
                        ...
                        from app.models.model import ClassSession
                    ...
                    if "error" not in ai_result:
                        ...
                        try:
                            ...
                            async with AsyncSession(async_engine) as unified_db:
                                ...
                                try:
                                    from app.models.model import AcademicCalendar, TeacherProfile
                                    from sqlalchemy import select
...
async def store_ai_response_in_temp_extract(teacher_id: str, class_name: str, subject: str, ai_response: Dict, gcs_file_name: str = None) -> None:
    ...
    try:
        ...
        async with AsyncSession(async_engine) as session:
            ...
            from sqlalchemy import select
            from app.models.model import TempExtract
            from uuid import UUID
