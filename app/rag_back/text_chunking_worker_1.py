...
Usage:
    python text_chunking_worker_1.py
    
    # Or use ARQ directly:
    python -m arq rag_back.text_chunking_worker_1
"""
...
try:
    from .text_chunking_worker import worker_config_1
except ImportError:
    # If running as script directly, add parent directory to path
    import os
    sys.path.insert(0, os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
    from app.rag_back.text_chunking_worker import worker_config_1
...
logging.basicConfig(
    ...
    handlers=[
        ...
        logging.FileHandler('text_chunking_worker_1.log', encoding='utf-8')
    ]
)
