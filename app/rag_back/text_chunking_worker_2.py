...
Usage:
    python text_chunking_worker_2.py
    
    # Or use ARQ directly:
    python -m arq rag_back.text_chunking_worker_2
"""
...
try:
    from .text_chunking_worker import worker_config_2
except ImportError:
    # If running as script directly, add parent directory to path
    import os
    sys.path.insert(0, os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
    from app.rag_back.text_chunking_worker import worker_config_2
...
logging.basicConfig(
    ...
    handlers=[
        ...
        logging.FileHandler('text_chunking_worker_2.log', encoding='utf-8')
    ]
)
