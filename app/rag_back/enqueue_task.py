...
Usage:
    from app.rag_back.enqueue_task import enqueue_text_chunking_task
...
try:
    from .rag_back import rag_redis_settings
except ImportError:
...
async def enqueue_text_chunking_task_round_robin(
    ...
    # Use the correct queue names that match the worker configuration
...
enqueue_rag_processing = enqueue_text_chunking_round_robin_sync
