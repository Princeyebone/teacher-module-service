"""
Temporary file with the _parse_notes_into_slides function to add to student_support_generator.py

INSERT THIS FUNCTION AT LINE 382 (right before _build_support_pack_slides)
"""
