...
from app.core.websocket_manager import connect_student_websocket, disconnect_student_websocket
import json
import asyncio
from app.api.routers.monitering import handle_student_log_message
from app.core.database import get_db
from sqlalchemy.ext.asyncio import AsyncSession

# ✅ Local Imports
import app.api.routers.auths_routes as auths_routes
import app.api.routers.profile_routes as profile_routes
import app.api.routers.teacher_crud as teacher_crud
import app.api.routers.timetable_crud as timetable_crud
import app.api.routers.calendar_crud as calendar_crud
import app.api.routers.productivity as productivity
from app.core.database import create_all_db_tables
from app.core.websocket_manager import redis_listener, connect_websocket, disconnect_websocket
from app.core.logger import logger
import app.api.routers.notifications_crud as notifications_crud
import app.api.routers.main_calendar_crud as main_calendar_crud
import app.services.semester_mapper as semester_mapper
import app.file_handler.tm_file_handler as tm_file_handler
import app.file_handler.ca_file_handler as ca_file_handler
import app.file_handler.sem_file_handler as sem_file_handler
import app.file_handler.curri_file_handler as curri_file_handler
import app.file_handler.outline as outline_handler
import app.file_handler.rag_file_handler as rag_file_handler
import app.api.routers.grade_crud as grade_crud
import app.services.gradeweights as gradeweights
import app.services.score as score
import app.api.routers.assessment as assessment
import app.api.routers.student_auth as student_auth
import app.api.routers.publishing as publishing
import app.api.routers.student_read as student_read
import app.api.routers.monitering as monitering
import app.api.routers.answer as answer
import app.rag.input as rag_input
import app.rag.retrievals as rag_retrievals
import app.api.routers.todays_overview as todays_overview
import app.file_handler.free_hand as free_hand_handler
import app.brief_sche.brief_routes as brief_routes
import app.file_handler.lesson_note_handler as lesson_note_handler
import app.file_handler.slide_handler as slide_handler
import app.file_handler.student_lesson_pack_handler as student_pack_handler
import app.file_handler.student_support_handler as student_support_handler

# gRPC Imports
import grpc
import app.teacher_grpc.teacher_pb2_grpc as teacher_pb2_grpc
from app.teacher_grpc.grpc_server import TeacherServiceServicer
...
app.include_router(rag_input.router)
app.include_router(rag_retrievals.router)
app.include_router(todays_overview.router)
app.include_router(free_hand_handler.router)
