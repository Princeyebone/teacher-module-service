...
from app.schemas.schemas import TeacherRegistrationRequest, StudentLoginRequest, StudentIDLoginRequest, StudentToken, StudentProfileResponse
from httpx import AsyncClient
from app.core.config import settings
from sqlalchemy.ext.asyncio import AsyncSession
from app.core.database import get_db
from uuid import UUID
from app.models.model import TeacherProfile, Student
from sqlalchemy.exc import IntegrityError
from app.core.logger import logger
from app.core.dependencies import get_current_teacher
from app.api.routers.student_auth import authenticate_student, authenticate_student_by_id, create_student_tokens, create_student, refresh_access_token
