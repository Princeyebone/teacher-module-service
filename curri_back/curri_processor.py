...
try:
    ...
    from model import KnowledgeMetadata, KnowledgeEmbedding, Strand, Substrand, ContentStandard, Indicator
...
try:
    from rag.text import extract_text_from_pdf_pymupdf, chunk_text_with_langchain
...
try:
    from rag.retrieval_task import perform_retrieval
